...
<div class="row g-4 mb-4">
    ...
    <div class="col-md-3">
        <div class="luxury-card text-center">
            ...
            <h3 class="text-gold mb-1"><?php echo e(\App\Models\Project::where('is_active', true)->count()); ?></h3>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="badge bg-secondary"><?php echo e(ucfirst($project->type)); ?></span>
                            </td>
                            <td>
                                <?php
                                $statusColors = [
    ...
    <div class="col-md-4">
        ...
        <div class="luxury-card mt-4">
            <div class="text-center">
                ...
                <h4 class="mb-1"><?php echo e(auth()->user()->first_name); ?> <?php echo e(auth()->user()->last_name); ?></h4>
                <p class="text-muted mb-2"><?php echo e(auth()->user()->role->name); ?></p>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Margadarsi Portal\Backend\resources\views/dashboard/index.blade.php ENDPATH**/ ?>