...
<script>
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            setTimeout(() => {
                window.location.href = '<?php echo e(route("departments.index")); ?>';
            }, 1500);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Margadarsi_portal\resources\views/departments/create.blade.php ENDPATH**/ ?>