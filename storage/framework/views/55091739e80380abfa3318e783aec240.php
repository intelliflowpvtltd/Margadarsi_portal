    ...
    <div class="col-lg-8 mx-auto">
        <div class="premium-card">
            <form id="createRoleForm">
                ...
                <!-- Company Assignment -->
                <input type="hidden" name="company_id" value="<?php echo e(auth()->user()->company_id ?? 1); ?>">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Margadarsi Portal\Backend\resources\views/roles/create.blade.php ENDPATH**/ ?>