...
<div class="auth-card-header">
    ...
    <p class="auth-card-subtitle">Enter the 6-digit code sent to <strong><?php echo e($maskedEmail ?: 'your email'); ?></strong></p>
</div>
...
<!-- Attempts Warning -->
<?php if(session('attempts_remaining')): ?>
<div class="alert alert-warning" role="alert">
    <i class="bi bi-exclamation-triangle me-2" aria-hidden="true"></i>
    <?php echo e(session('attempts_remaining')); ?> attempts remaining
</div>
<?php endif; ?>

<!-- OTP Verification Form -->
<form method="POST" action="<?php echo e(route('password.verify-otp')); ?>" class="auth-form" novalidate>
    <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Margadarsi_portal\resources\views/auth/verify-otp.blade.php ENDPATH**/ ?>