...
<div class="page-header">
    <div class="d-flex justify-content-between align-items-center">
        ...
        <a href="<?php echo e(route('projects.create')); ?>" class="btn btn-maroon">
...
<div class="premium-card">
    ...
    <div id="emptyState" class="text-center py-5" style="display: none;">
        ...
        <a href="<?php echo e(route('projects.create')); ?>" class="btn btn-maroon mt-3">
            <i class="bi bi-plus-circle me-2"></i>
            Add Project
        </a>
    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Margadarsi_portal\resources\views/projects/index.blade.php ENDPATH**/ ?>