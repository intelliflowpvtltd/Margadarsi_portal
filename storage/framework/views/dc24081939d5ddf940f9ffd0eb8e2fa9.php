...
<?php $__env->startSection('title', 'Amenity Categories - Master Data'); ?>

<?php $__env->startSection('content'); ?>
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="mb-1 fw-bold">Amenity Categories</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="<?php echo e(route('masters.index')); ?>">Masters</a></li>
                    <li class="breadcrumb-item active">Amenity Categories</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-hover" id="dataTable">
                    <thead><tr><th>#</th><th>Name</th><th>Icon</th><th>Amenities</th><th>Status</th><th>Actions</th></tr></thead>
            ...
            <div id="emptyState" class="text-center py-5 d-none"><i class="bi bi-grid display-4 text-muted"></i><p class="mt-2 text-muted">No categories found</p></div>
        </div>
    </div>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="itemForm">
                    ...
                    <div class="mb-3"><label class="form-label">Name <span class="text-danger">*</span></label><input type="text" class="form-control" name="name" id="itemName" placeholder="e.g., Security, Recreation, Utilities" required></div>
                    <div class="mb-3"><label class="form-label">Icon</label><input type="text" class="form-control" name="icon" id="itemIcon" placeholder="e.g., bi-shield, bi-controller"></div>
...
<script>
const API_BASE='/admin/masters/amenity-categories';let itemsData=[];
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Margadarsi_portal\resources\views/masters/amenity-categories.blade.php ENDPATH**/ ?>