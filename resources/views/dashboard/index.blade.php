    ...
    <div class="col-12">
        <div class="luxury-card">
            <div class="luxury-card-header">
                ...
                <a href="{{ route('leads.index') }}" class="btn btn-sm btn-outline-gold">
        ...
        <div class="luxury-card h-100">
            ...
            <div class="p-3">
                ...
                <div class="d-flex justify-content-between py-2">
                    ...
                    <span class="fw-bold text-gold">{{ \App\Models\Project::where('is_active', true)->count() }}</span>
                </div>
            </div>
        </div>
    </div>
                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="badge bg-secondary">{{ ucfirst($project->type) }}</span></td>
                            <td>
                                @php
                                $statusColors = ['upcoming'=>'info','ongoing'=>'warning','completed'=>'success','on-hold'=>'danger'];
                                @endphp
                                <span class="badge bg-{{ $statusColors[$project->status] ?? 'secondary' }}">{{ ucfirst($project->status) }}</span>
                            </td>
                            <td>{{ $project->city }}</td>
                        </tr>
                        @endforeach
    ...
    <div class="col-md-4">
        <div class="luxury-card mb-4">
            ...
            <div class="d-grid gap-2 p-3">
                <a href="{{ route('leads.index') }}" class="btn btn-outline-gold">
        ...
        <div class="luxury-card">
            <div class="text-center p-3">
                ...
                <p class="text-muted mb-1 small">{{ auth()->user()->role->name ?? 'N/A' }}</p>
