        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-hover" id="dataTable">
                    <thead><tr><th>#</th><th>Label</th><th>Min Days</th><th>Max Days</th><th>Order</th><th>Status</th><th>Actions</th></tr></thead>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="itemForm">
                    ...
                    <div class="mb-3"><label class="form-label">Label <span class="text-danger">*</span></label><input type="text" class="form-control" name="label" id="itemLabel" placeholder="e.g., Immediate, 1-3 Months" required></div>
                    <div class="row">
